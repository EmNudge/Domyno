import { pipe, collect, } from '../../src/utils';
import { reduce } from '../../src/pipeable/consumers';
import { 
	map, filter, take, takeWhile, 
	flat, flatMap, slice, 
	chunk, tap, cycle
} from '../../src/pipeable/lazy';
